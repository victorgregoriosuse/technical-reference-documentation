...
// document
// -
:title: NVIDIA GPU Operator with RKE2
:subtitle: Deploying the NVIDIA GPU operator on an RKE2 cluster with SLES15

:product1: RKE2
:product1_full: Rancher Kubernetes Engine 2
:product1_version: v1.25.12+rke2r1
:product1_url: docs.rke2.io/
:product2: SLES
:product2_full: SUSE Linux Enterprise Server
:product3_version: 15 SP4
:product2_url: www.suse.com/products/server/

:usecase: Simplify the deployment of the NVIDIA GPU operator on RKE2 clusters.
...
// -
:author1_firstname: Victor
:author1_surname: Gregorio
:author1_jobtitle: Senior Manager, Solutions Architects
